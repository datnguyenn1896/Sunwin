                    ...
                    while True:
                        ...
                        try: 
                            ...
                            if data[0] == 5 and (data[1]["cmd"] == 1957 or data[1]["cmd"] == 1008 ):
                                ...
                                with open('login-1.txt', 'r', encoding='utf-8') as file:
                            ...
                            elif data_status[username]["session_bet"] != None and data_status[username]["current_session"] > data_status[username]["session_bet"] and name != "balance":
...
with open('login-1.json', 'r') as file:
    login = file.read()
